...
console.log(`Person's email address:${latitude},${longitude}`);
...
console.log(`Person's occupation: "Software Engineer:${occupation}`);
...
let followersNumbers:string="1,000,000";
console.log(`Number of followers on a social media platform:${followersNumbers}`);
